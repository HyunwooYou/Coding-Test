...
공중 미래 도시에는 1번부터 N번까지의ㅏ 회사가 있는데 특정 회사끼리는 서로 도로를 통해 연결되어 있다.
...
방문 판매워 A는 X번 회사에 가서 물건을 판매하기 전에 먼저 소개팅 상대의 회사에 찾아가서 함께 커피를 마실 예정이다.
...
예를 들어 N = 5, X = 4, K = 5이고 회사 간 도로가 7개면서 각 도로가 다음과 같이ㅏ 연결되어 있을 때를 가정할 수 있다.
