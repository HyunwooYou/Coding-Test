"""
* Title: 플로이드워셜 - 미래 도시
방문 판매원 A는 많으 회사가 모여 있는 공중 미래 도시에 있다.
...
또한 연결된 2개의 회사를 양방향으로 이동할 수 있다.
공중 미래 도시에서의 도로는 마하의 속도로 사람을 이동시켜주기 때문에 특정 회사와 다른 화사가 도로로 연결되어 있다면,
정확히 1만큼의 시간으로 이동할 수 있다.

또한 오늘 방문 판매원 A는 가대하던 소개팅에도 참석하고자 한다. 소개팅의 상대는 K번 회사에 존재한다.
방문 판매원 A는 X번 회사에 가서 물건을 판매하기 전에먼저 소개팅 상대의 회사에 찾아가서 함께 커피를 마실 예정이다.
...
예를 들어 N = 5, X = 4, K = 5이고 회사 간 도로가 7개면서 각 도로가 다음과 같이 연결되어 있을 때는 가정할 수 있다.

(1번, 2번), (1번, 3번), (1번, 4번), (2번, 4번), (3번, 4번), (3번, 6번), (4번, 5번)
